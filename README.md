...
- ✅ **Admin interface**: HTTP on port 3000
...
| [adguard-home.nix](modules/adguard-home.nix) | AdGuard Home with SOPS password injection |
...
Access web interface: `http://localhost:3000` (admin password from SOPS)
